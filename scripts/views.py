...
replication = {
    "_id": (f"{source.get('capDb')}_{source.get('FQDN')}_to_{source.get('FQDN')}"),
    "source":  {
...
replicationMetfareIncidents = {
    "_id": (f"{source.get('metfareIncidents')}_{source.get('FQDN')}_to_{source.get('FQDN')}"),
    "source":  {
        "url": (f"{source.get('protocol')}://{source.get('FQDN')}/{source.get('metfareIncidents')}"),
        "auth": {
            "basic": {
                "username": (f"{source.get('username')}"),
                "password": (f"{source.get('password')}")
    ...
    "target": {
        "url": (f"{target.get('protocol')}://{target.get('FQDN')}:{target.get('port')}/{target.get('metfareIncidents')}"),
        "auth": {
            "basic": {
                "username": (f"{target.get('username')}"),
                "password": (f"{target.get('password')}")
...
try:
    ...
    pass 
try:
    db.save(replicationMetfareIncidents)
except Exception as e:
    print(f'Could not save document : {e}')
    pass 
...
################################################################################
#                                                                              #
# Design documents for the incidents and warings databases                     #
# The databases are replicated from https://db-b.metfare.met.no/               #
#                                                                              #
################################################################################
